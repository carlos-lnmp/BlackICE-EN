...
NDiplomacy = {
	...
	TENSION_SIZE_FACTOR = 0.70,						-- All action tension values are multiplied by this value
...
NCountry = {
	EVENT_PROCESS_OFFSET = 16, 									-- When you change this change blackiceevents.1; Events are checked every X day per character or province (1 is ideal, but CPU heavy)
	...
	SUPPLY_FROM_DAMAGED_INFRA = 0.33,                			-- damaged infrastructure counts as this in supply calcs
	SUPPLY_BASE_MULT = 0.91,									-- multiplier on supply base values
	...
	RESISTANCE_STRENGTH_FROM_UNIT = 0.003,						-- How much strength ticking speed is reduced from each unit in state (multiplies subunit value resistance_suppress)
	...
	SUPPLY_CONVOY_FACTOR = 0.85,									-- How many convoys each supply needs
	CONVOY_RANGE_FACTOR = 1.100,                        		-- how much range affects convoy need
	LOCAL_MANPOWER_ACCESSIBLE_NON_CORE_FACTOR = 0.02,         	-- was 0.45 accessible recruitable factor base	
	...
	MAX_BOMBING_WAR_SUPPORT_IMPACT = 0.0,					--  DO NOT MODIFY causes wacky WS bug, Max total penalty from bomber's damage
	...
	BASE_MAX_COMMAND_POWER = 95.0,							-- base value for maximum command power
	...
	BASE_FUEL_CAPACITY = 20000,						-- base amount of fuel capacity
...
NProduction = {
	MAX_EQUIPMENT_RESOURCES_NEED = 10, 							-- Max number of different strategic resources an equipment can be dependent on.
	...
	MAX_MIL_FACTORIES_PER_LINE = 240,
	...
	BASE_FACTORY_EFFICIENCY_PARENT_CHANGE_FACTOR = 80,			-- Base factor for changing production parent<->children in %.
	BASE_FACTORY_EFFICIENCY_FAMILY_CHANGE_FACTOR = 80,			-- Base factor for changing production with same family in %.
	...
	CONVERSION_SPEED_BONUS = 1.0,								-- Modifier to the production speed when converting equipment
...
NBuildings = {
	...
	NAVALBASE_REPAIR_MULT = 0.10,					-- Each level of navalbase building repairs X strength. The value is spread on all ships needed reparation. Fe Navalbase lvl 5 x 0.5 str repair = 2.5 str repaired over 10 ships, so each ship repair hourly 0.25 str.
...
NMilitary = {
	...
	HOURLY_ORG_MOVEMENT_IMPACT = -0.5,		-- modifier to recovery rate when moving
	...
	WAR_SCORE_LOSSES_RATIO = 0.5,				-- Scale how much losses will affect warscore ( per 1000 losses ).
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 16,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	RECON_SKILL_IMPACT = 2, 				-- how many skillpoints is a recon advantage worth when picking a tactic.
	...
	BASE_COMBAT_WIDTH = 75,                       		-- base combat width
	ADDITIONAL_COMBAT_WIDTH = 25,                  		-- more opened up by support attack
	...
	EQUIPMENT_COMBAT_LOSS_FACTOR = 0.6,	 	       	-- % of equipment lost to strength ratio in combat, so some % is returned if below 1
	...
	TRAINING_MIN_STRENGTH = 0.15,					-- if strength is less than this, the unit will pause training until it's been reinforced
	...
	STRATEGIC_INFRA_SPEED = 8.0,                   	-- Max of additional speed gained through level for strategic redeployment per infra
	STRATEGIC_REDEPLOY_ORG_RATIO = 0.15,			-- Ratio of max org while strategic redeployment
	BATALION_NOT_CHANGED_EXPERIENCE_DROP = 0.15,	-- Division experience drop if unit has same batalion
	BATALION_CHANGED_EXPERIENCE_DROP = 0.6,			-- Division experience drop if unit has different batalion
	ARMOR_VS_AVERAGE = 0.6,			                -- how to weight in highest armor vs the division average
	PEN_VS_AVERAGE = 0.5,							-- how to weight in highest piercing vs the division average
	...
	MIN_DIVISION_DEPLOYMENT_TRAINING = 0.45,			-- Min level of division training
	...
	ACCLIMATIZATION_LOSS_SPEED_FACTOR = 3.0,			-- Loosing one acclimatization while being under affect of the opposite climate should cause it to drop down much faster than gaining.
	...
	OUT_OF_FUEL_TRAINING_XP_GAIN_MULT = -0.33,				-- xp gain mult from training when a unit is out of fuel
	FUEL_CAPACITY_DEFAULT_HOURS = 73             			-- default capacity if not specified becomes 96 with jerrycans (32% increase)
},
...
NAir = {
	...
	ACE_WING_SIZE =	125,								-- size of wing ace bonuses are set up for. if lower more bonus, if higher less bonus
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.20,					-- Anti Air Gun Damage factor
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.15,					-- Anti Air Gun hit chance
	ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 0.9,	-- Balancing value to convert equipment stat anti_air_attack to the damage reduction modifier apply to incoming air attacks against units with AA.
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_MIN_CAP = 5,			-- Min cap for planes that can join naval combat
	...
	AIR_WING_XP_LEVELS = { 25, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 950 }, 						--Experience needed to progress to the next level
	...
	DISRUPTION_FACTOR_CARRIER = 16.0,									-- multiplier on disruption damage to scale its effects on carrier vs carrier planes
	...
	MISSION_FUEL_COSTS = {  -- fuel cost per plane for each mission
		0.5, -- AIR_SUPERIORITY  		#1.0
		0.5, -- CAS						#1.0
		0.25, -- INTERCEPTION
		0.8, -- STRATEGIC_BOMBER
		0.8, -- NAVAL_BOMBER
		2.0, -- DROP_NUKE				#1.0
		1.0, -- PARADROP
		...
		0.75, -- AIR_SUPPLY				#1.0
		0.3, -- TRAINING
		0.5, -- NAVAL_MINES_PLANTING	#1.0
		0.5, -- NAVAL_MINES_SWEEPING	#1.0
	},
	MAX_FUEL_FLOW_MULT = 1.0, -- max fuel flow ratio for planes, which will be multiplied by supply
	
	FUEL_COST_MULT = 0.65, -- fuel multiplier for all air missions
	...
	NAVAL_MINES_PLANTING_SPEED_MULT = 0.020,						-- Value used to overall balance of the speed of planting naval mines
...
NNavy = {
	...
	DETECTION_CHANCE_MULT_RADAR_BONUS = 0.2,						-- detection chance bonus from radars. 
	...
	BEST_CAPITALS_TO_SCREENS_RATIO = 0.34, 							-- capitals / screens ratio used for creating FEX groups in naval combat
	COMBAT_BASE_HIT_CHANCE = 0.1,									-- base chance for hit (in %)

	COMBAT_MIN_HIT_CHANCE = 0.01 ,									-- never less hit chance then this?
	...
	COMBAT_DAMAGE_TO_STR_FACTOR = 1.2,								-- casting damage value to ship strength multiplier. Use it ot balance the game difficulty.
	COMBAT_DAMAGE_TO_ORG_FACTOR = 1.8,								-- casting damage value to ship organisation multiplier. Use it to balance the game difficulty.
	...
	COMBAT_DETECTED_CONVOYS_FROM_SURFACE_DETECTION_STAT = 0.05,		-- Each 1.0 of surface_detection that ship has (equipment stat), gives x% of convoys discovered from total travelling along the route.
	...
	REPAIR_AND_RETURN_PRIO_LOW = 0.5,								-- % of total Strength. When below, navy will go to home base to repair.
	REPAIR_AND_RETURN_PRIO_MEDIUM = 0.7,							-- % of total Strength. When below, navy will go to home base to repair.
	REPAIR_AND_RETURN_PRIO_HIGH = 0.9,								-- % of total Strength. When below, navy will go to home base to repair.
	REPAIR_AND_RETURN_PRIO_LOW_COMBAT = 0.4,						-- % of total Strength. When below, navy will go to home base to repair (in combat).
	...
	REPAIR_AND_RETURN_UNIT_DYING_STR = 0.35,						-- Str below this point is considering a single ship "dying", and a high priority to send to repair.
	EXPERIENCE_LOSS_FACTOR = 1.00,                 					-- percentage of experienced solders who die when manpower is removed
	...
	ANTI_AIR_ATTACK_TO_AMOUNT = 0.025,								-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.
	...
	EXPERIENCE_FACTOR_CARRIER_GAIN = 0.075,							-- Xp gain by carrier ships in the combat
	...
	CONVOY_ATTACK_BASE_FACTOR = 0.08,                               -- base % of convoys that get intercepted
	...
	CARRIER_STACK_PENALTY_EFFECT = 0.05,							-- Each carrier above the optimal amount decreases the amount of airplanes being able to takeoff by such %.
	...
	ON_BASE_FUEL_COST = 0.06,										-- ships that waits at naval bases cost this ratio
	...
	FUEL_COST_MULT = 0.225, -- fuel multiplier for all naval missions
	...
	NAVAL_MINES_SWEEPING_SPEED_MULT = 0.005,						-- Value used to overall balance of the speed of sweeping naval mines
	...
	NAVAL_MINES_ENCRYPTION_VS_DECRYPTION_FACTOR = 0.2,				-- Better our decryption over enemy encryption will reduce the penalties from the enemy mines in the region. This value is a factor to be used for balancing.
	...
	TRAINING_DAILY_COUNTRY_EXP_SHIP_RATIO_FACTOR = 300.0,			-- Maximum navy XP daily gain
	TRAINING_MAX_DAILY_COUNTRY_EXP = 4.0,							-- Maximum navy XP daily gain
	...
	SPOTTING_SPEED_MULT_FOR_CATCHING_UP = 0.5,						-- speed diff bonus rate that is added to spotting every hour
	...
	SPEED_TO_ESCAPE_SPEED = 1.5,									-- ratio to converstion from ship speed to escape speed (divided by hundred)
	ESCAPE_SPEED_PER_COMBAT_DAY = 0.2,								-- daily increase in escape speed during combat duration
	...
	HEAVY_GUN_ATTACK_TO_SHORE_BOMBARDMENT							= 0.04,  -- heavy gun attack value is divided by this value * 100 and added to shore bombardment modifier
	LIGHT_GUN_ATTACK_TO_SHORE_BOMBARDMENT							= 0.04, -- light gun attack value is divided by this value * 100 and added to shore bombardment modifier
	...
	DEPTH_CHARGES_HIT_CHANCE_MULT 									= 0.5, 		-- multiplies hit chance of depth charges
	...
	CONVOY_DEFENSE_MAX_CONVOY_TO_SHIP_RATIO							= 4.5,		-- each ship in convoy defense mission can at most cover this many convoys without losing efficiency
	CONVOY_DEFENSE_MAX_REGION_TO_TASKFORCE_RATIO					= 2.0,		-- each taskforce in convoy defense mission can at most cover this many regions without losing efficiency
	...
	WARSCORE_GAIN_FOR_SUNK_SHIP_PRODUCTION_COST_FACTOR = 0.0004,
...
NTrade = {
	...
	PUPPET_MASTER_TRADE_FACTOR = 1000,			-- This is priority for puppet master
...
NAI = {
	...
	MIN_FORCE_RATIO_TO_PROTECT = 0,				-- Tiny countries should not feel protective for really large ones
...
-- EXPEDITIONARY FORCES LOGIC 
	...
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 0.2, 	-- How willing major powers are to send volunteers.
...
-- RESEARCH 
	...
	RESEARCH_NEW_WEIGHT_FACTOR = 0, 				-- Impact of previously unexplored tech weights. Higher means more random exploration.
	RESEARCH_AHEAD_BONUS_FACTOR = 2.0,          	-- To which extent AI should care about ahead of time bonuses to research
	RESEARCH_BONUS_FACTOR = 0, 					-- To which extent AI should care about bonuses to research
...
-- BATTLE PLAN & FRONT LOGIC
	...
	RELUCTANCE_TO_CHANGE_FRONT_FACTOR = 1.0,			-- Factor for how reluctant the AI is to change a units order group.
	...
	MIN_PLAN_VALUE_TO_MICRO_INACTIVE = 0.1,				-- The AI will not consider members of groups which plan is not activated AND evaluates lower than this. (prevents maginot push while taking belgium)
	...
	FRONT_EVAL_UNIT_ACCURACY = 0.75,                             -- scale how stupid ai will act on fronts. 0 is potato
	...
	PLAN_FACTION_WEAK_TO_ABORT = 0.3,			-- % or more of units in an order to consider executing the plan
	...
	FORTIFIED_RATIO_TO_CONSIDER_A_FRONT_FORTIFIED = 0.15, -- ai will consider a front fortified if this ratio of provinces has fort
	HEAVILY_FORTIFIED_RATIO_TO_CONSIDER_A_FRONT_FORTIFIED = 0.25, -- ai will consider a front super fortified if this ratio of provinces has lots of forts
	...
	MICRO_POCKET_SIZE = 2,						-- Pockets with a size equal to or lower than this will be mocroed by the AI, for efficiency.
	...
	DESPERATE_AI_MIN_UNIT_ASSIGN_TO_ESCAPE = 3,			-- AI will assign at least this amount of units to break from desperate situations
	...
	SUPPLY_CRISIS_LIMIT = 0.95,					-- If a unit is standing in an area with 
	AVERAGE_SUPPLY_USE_PESSIMISM = 2,			-- Multiplier for when AI calculates average supply use of entire army..
	...
	AREA_DEFENSE_CIVIL_WAR_IMPORTANCE = 10000,			-- Area defense order importance value when a country is in a civil war as target or revolter.				-- 0 = Never, 1 = Infantry/Artillery, 2 = Go wild
...
-- DESIGN & XP LOGIC
	...
	VARIANT_UPGRADE_MIN_XP = 150,				-- Minimum XP before attempting to create a new variant.
	...
	MAX_SUPPLY_DIVISOR = 0.10,							-- To make sure the AI does not overdeploy divisions. Higher number means more supply per unit
...
-- ARMY LOGIC
	...
	MIN_UNITS_FACTOR_FRONT_ORDER = 0.8,					-- Factor for min number of units to assign to area front orders

	MAX_UNITS_FACTOR_INVASION_ORDER = 1.5,				-- Factor for max number of units to assign to naval invasion orders
	DESIRED_UNITS_FACTOR_INVASION_ORDER = 1.5,			-- Factor for desired number of units to assign to naval invasion orders
	MIN_UNITS_FACTOR_INVASION_ORDER = 1.0,				-- Factor for min number of units to assign to naval invasion orders
	
	
-- AIR ASSIGNMENT LOGIC
	AIR_SCORE_DISTANCE_IMPACT = 1.0,					-- Effect of distance applied to the score calculations
	...
	AIR_WING_REINFORCEMENT_LIMIT = 50,
	...
	LAND_DEFENSE_CIVIL_FACTORY_IMPORTANCE = 30,			-- Strategic importance of civil factories
	LAND_DEFENSE_MILITARY_FACTORY_IMPORTANCE = 40,		-- Strategic importance of military factories
	LAND_DEFENSE_NAVAL_FACTORY_IMPORTANCE = 20,			-- Strategic importance of naval factories
	LAND_DEFENSE_AA_IMPORTANCE_FACTOR = 1.0,			-- Factor of AA influence on strategic importance ( 0.0 - 1.0 )
	LAND_DEFENSE_INFRA_IMPORTANCE_FACTOR = 0.8,			-- Factor of infrastructure influence on strategic importance ( 0.0 - 1.0 )
	LAND_DEFENSE_IMPORTANCE_SCALE = 1.0,				-- Lend defence total importance scale (every land defence score get's multiplied by it)
	...
	LAND_DEFENSE_INTERSEPTORS_PER_BOMBERS = 0.5,		-- Amount of air interceptor planes requested per enemy bomber
	LAND_DEFENSE_INTERSEPTORS_PER_PLANE = 0.5,				-- Amount of air interceptor planes requested per enemy plane (non bomber)
	...
	LAND_COMBAT_MIN_EXCORT_WINGS = 5,					-- Min amount of airwings requested to excort operations
	...
	STR_BOMB_IMPORTANCE_SCALE = 0.1,					-- str bombing total importance scale (every str bombing score get's multiplied by it)
	...
	STR_BOMB_PLANES_PER_CIV_FACTORY = 80,				-- Amount of planes requested per enemy civ factory
	STR_BOMB_PLANES_PER_MIL_FACTORY = 100,				-- Amount of planes requested per enemy military factory
	STR_BOMB_PLANES_PER_NAV_FACTORY = 60,				-- Amount of planes requested per enemy naval factory
	STR_BOMB_MIN_EXCORT_WINGS = 4,						-- Min amount of airwings requested to excort operations
	
	TRANSPORTS_PER_PARATROOPER = 120,					-- Air transports only duty is to drop paratroopers.
...
-- AI PP LOGIC
	...
	POLITICAL_IDEA_MIN_SCORE = 1,				-- Only replace or add an idea if score is above this score.
...
-- DEPLOYMENT LOGIC
	...
	MAX_AVAILABLE_MANPOWER_RATIO_TO_BUFFER_WARTIME = 0.1,			-- deployment will try to buffer a ratio of manpower (for reinforcements) during war time
...
-- NAVAL LOGIC
	...
	CAPITAL_TASKFORCE_MAX_CAPITAL_COUNT = 8, 		-- optimum capital count for capital taskforces
	SCREEN_TASKFORCE_MAX_SHIP_COUNT = 8,			-- optimum screen count for screen taskforces
	SUB_TASKFORCE_MAX_SHIP_COUNT = 6,				-- optimum sub count for sub taskforces
	
	MIN_CAPITALS_FOR_CARRIER_TASKFORCE = 5,			-- carrier fleets will at least have this amount of capitals
	...
	NAVAL_MISSION_ESCORT_NEAR_OWNED = 5000,			-- Extra escort mission score near owned provinces
	NAVAL_MISSION_PATROL_NEAR_CONTROLLED = 7000,		-- Extra patrol mission score near controlled provinces
	NAVAL_MISSION_ESCORT_NEAR_CONTROLLED = 2500,		-- Extra escort mission score near controlled provinces
	...
	MAX_SCREEN_TASKFORCES_FOR_CONVOY_DEFENSE_MIN_CONVOY_THREAT = 50, -- AI will increase screen assignment for escort missions as threate increases
	...
	MAX_SCREEN_TASKFORCES_FOR_MINE_SWEEPING_PRIO = 0.2, 			-- if you have mines near your owned states, you will start priotize mine missions and will assign this ratio of screens
	...
	MAX_PATROL_TO_STRIKE_FORCE_RATIO = 2.0,					-- maximum patrol/strike force ratio
...
-- CONVOY LOGIC
	...
	REGION_THREAT_PER_SUNK_CONVOY = 20,					-- Threat value per convoy sunk in a region. Decays over time.
	...
	CONVOY_ESCORT_SCORE_FROM_CONVOYS = 30,                        -- score for each convoy you have in area
...
-- FUEL LOGIC
	...
	MAX_FUEL_CONSUMPTION_RATIO_FOR_NAVY_TRAINING = 0.1,		-- ai will use at most this ratio of affordable fuel for naval training
	
	MAX_FULLY_TRAINED_SHIP_RATIO_FOR_TRAINING = 0.7,			-- ai will not train a taskforce if fully trained ships are above this ratio
	
	NUM_SILOS_PER_CIVILIAN_FACTORIES = 0.0028,					-- ai will try to build a silo per this ratio of civ factories
	NUM_SILOS_PER_MILITARY_FACTORIES = 0.014,					-- ai will try to build a silo per this ratio of mil factories
	NUM_SILOS_PER_DOCKYARDS = 0.04,								-- ai will try to build a silo per this ratio of dockyards
...
-- INVASION LOGIC
	...
	MAX_DISTANCE_NALAV_INVASION = 700.0,						-- AI is extremely unwilling to plan naval invasions above this naval distance limit.
	MIN_INVASION_PLAN_VALUE_TO_EXECUTE = 0.8,					-- AI will only activate invasions if it is above this
	...
	INVASION_DISTANCE_RANDOMNESS = 300,							-- The higher this value, the more unpredictable the invasions. Compares to actual map distance in pixels.
